...
foreach ($service in @('CrmLocalDeRopaWeb', 'CrmLocalDeRopaApi')) { Stop-Service -Name $service -Force -ErrorAction Stop }
...
try {
    ...
    $password = Unprotect-CrmSecret -Path 'C:\ProgramData\CRM-LocalDeRopa\secrets\database-password.dpapi'
    ...
    foreach ($service in @('CrmLocalDeRopaApi', 'CrmLocalDeRopaWeb')) { Start-Service -Name $service }
    ...
    foreach ($service in @('CrmLocalDeRopaWeb', 'CrmLocalDeRopaApi')) { Stop-Service -Name $service -Force -ErrorAction SilentlyContinue }
    ...
    foreach ($service in @('CrmLocalDeRopaApi', 'CrmLocalDeRopaWeb')) { Start-Service -Name $service -ErrorAction SilentlyContinue }
